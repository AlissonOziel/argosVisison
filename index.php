<?php
    ...
    $sql = "SELECT  a.id,
                    ...
                    SUM(a.quantity * a.value) as invest, 
    ...
    $totalValue = $resultTotal['total_stock_value'];
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-lg-7 col-12">
                            ...
                            <div class="custom-block custom-block-balance">
                                ...
                                <h2 class="mt-2 mb-3">
                                    R$<?php echo $sumTotalSales; ?>
                                </h2>

                                <div class="d-flex">
                                    <div>
                                        <small>N° de Vendas</small>
                                        <p>
                                            <?php echo $countTotalSales; ?>
                                        </p>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h6>Estoque <?php echo $product['stoke']; ?></h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ms-auto me-4">
                                            ...
                                            <h6>R$<?php echo $product['invest']; ?></h6>
                                        </div>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="custom-block custom-block-profile-front custom-block-profile text-center bg-white">
                                ...
                                <p class="d-flex flex-wrap mb-2">
                                    ...
                                    <span>R$<?php echo $totalValue;?></span>
                                </p>
                            ...
                            <div class="custom-block custom-block-profile-front custom-block-profile text-center bg-white">
                                ...
                                <p class="d-flex flex-wrap mb-2">
                                    ...
                                    <span><?php echo $sum_us; ?></span>
                                </p>

                                <p class="d-flex flex-wrap mb-2">
                                    <strong>Total de Vendedores:</strong>
                                    
                                    <span><?php echo $count_us; ?></span>
                                </p>
                            ...
                            <div class="custom-block custom-block-bottom d-flex flex-wrap">
                                ...
                                <div class="custom-block-bottom-item">
                                    <a href="users.php" class="d-flex flex-column">
                                        <i class="custom-block-icon bi bi-people"></i>
                            ...
                            <div class="custom-block custom-block-transations">
                                ...
                                <h5 class="mb-4">Atribuição</h5>
                                    ...
                                    <?php while($atri = $ra->fetch(PDO::FETCH_ASSOC)): ?>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p>
                                                        <a href="detailUser.php?id=<?php echo $atri['id_user']; ?>">
                                                            <?php echo $atri['name']; ?>
                                                        </a>
                                                    </p>
                                            ...
                                            <div class="ms-auto">
                                                <small>Produtos</small>
                                                <strong class="d-block text-success"> <?php echo $atri['totalAttribuition']; ?></strong>
                                            </div>
                                        </div>
                                        <hr>
                                    <?php endwhile; ?>
