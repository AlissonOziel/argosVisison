            ...
            <div class="row">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
                    ...
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0">Editar Produtos</h1>
                    </div>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="custom-block bg-white">
                                ...
                                <div class="" id="">
                                    ...
                                    <form class="custom-form password-form" action="process/editProduct.php" method="post" role="form">
                                        <input type="hidden" value="<?php echo $product['id']; ?>" name="id" id="id" class="form-control" required="">
                                        <input type="text" value="<?php echo $product['name']; ?>" name="name" id="name" class="form-control" placeholder="Nome do Produto" required="">

                                        <input type="number" value="<?php echo $product['quantity']; ?>" name="quantity" id="quantity" class="form-control" placeholder="Quantidade" required="">

                                        <input type="number" value="<?php echo $product['value']; ?>" name="value" id="value" class="form-control" placeholder="Valor" required="">

                                        <input type="number" value="<?php echo $product['price']; ?>" name="price" id="price" class="form-control" placeholder="Preço" required="">
