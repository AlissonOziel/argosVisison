            ...
            <div class="row">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
                    ...
                    <div class="position-sticky py-4 px-3 sidebar-sticky">
                        ...
                        <ul class="nav flex-column h-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="attribution.php">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
                    ...
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0">Atribuição de Produtos</h1>
                    </div>
                            ...
                            <div class="custom-block custom-block-profile">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-12 mb-3">
                                        <!-- <h6>Distribuição de Produtos</h6> -->
                                    </div>

                                    <form action="process/cadAttribution.php" method="POST" lass="custom-form password-form">
                                        ...
                                        <div class="col-lg-9 col-12">
                                            ...
                                            <p class="d-flex flex-wrap mb-2">
                                                ...
                                                <select name="seller" class="form-control">
                                                    ...
                                                    <?php while($user = $userR->fetch(PDO::FETCH_ASSOC)): ?>
